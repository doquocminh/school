<?php
    ...
    $tz_general_archive_feature_image_size = get_theme_mod( 'tz_general_archive_feature_image_size', 'full' );
    ...
    echo '<a href="'.get_permalink().'">';
	    if ( has_post_thumbnail() ) {
	        the_post_thumbnail( $tz_general_archive_feature_image_size ,$tz_image_title ,$tz_image_alt );
	    }

        /* Hide Post Format */
        $tz_hide_archive_post_format = get_theme_mod( 'tz_hide_archive_post_format', '0' );
        if( $tz_hide_archive_post_format != '1' ) {
