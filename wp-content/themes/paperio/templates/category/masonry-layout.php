<?php
    ...
    $tz_post_class_list[] = ( $tz_general_category_column_type == 'four-columns' ) ? 'masonry-four-columns-button': ''; 
    ...
    ob_start();
        add_action( 'post_class', 'paperio_category_masonry_post_class' );
        post_class( $tz_post_class_list );
        remove_action( 'post_class', 'paperio_category_masonry_post_class' );
        ...
        echo '<div class="blog-details">';
            ...
            echo '<div class="blog-meta text-uppercase">';
                if( $tz_hide_category_read_more_button != 1 ) {
                    echo '<a href="'.get_permalink().'" class="btn btn-very-small text-uppercase alt-font no-letter-spacing'.esc_attr( $blog_button_color_class ).'">'.esc_attr( $tz_default_button_text ).' '.$tz_category_read_more_button_arrow.'';
                    echo '</a>';
                }
