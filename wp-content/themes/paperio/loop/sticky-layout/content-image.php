<?php
    ...
    if ( has_post_thumbnail() ) {
        ...
        $tz_sticky_blog_layout_feature_image = get_theme_mod( 'tz_sticky_blog_layout_feature_image', 'full' );
        ...
        echo '<a href="'.get_permalink().'">';
    	    if ( has_post_thumbnail() ) {
    	        the_post_thumbnail( $tz_sticky_blog_layout_feature_image, $tz_image_title ,$tz_image_alt );
    	    }

            /* Hide Post Format */
            $tz_hide_sticky_blog_post_format = get_theme_mod( 'tz_hide_sticky_blog_post_format', 0 );
            if( $tz_hide_sticky_blog_post_format != '1' ) {
